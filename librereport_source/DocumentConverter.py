...
# WARNING
#
# This script MUST BE run with the python distributed with Libre/Open Office as such we shouldn't need to modify
# the system path as that script will set it up for us.
#
########################################################################################################################

# sys.path.append('/opt/openoffice.org/basis3.1/program/')
# sys.path.append('/opt/openoffice.org/basis3.3/program/')
# prefer libre office
# sys.path.insert(0,"/opt/libreoffice3.5/program/")
#sys.path.append('/opt/oopool/libreoffice-testing/libreoffice/program/');
#sys.path.append('/opt/oopool/libreoffice/libreoffice/program/');
...
########################################################################################################################
# Russ - Modifications to read our configured ports from the oopool configuration if it exists.
from pyjavaproperties import Properties
try:
    if os.path.exists("/opt/oopool/oopool"):
        oopool_base = "/opt/oopool/oopool"
    else:
        oopool_base = "/opt/oopool/oopool-testing"

    props = Properties()
    props.load(open(oopool_base + '/conf/config.properties'))
