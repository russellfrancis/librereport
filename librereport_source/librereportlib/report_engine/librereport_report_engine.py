...
class report_engine:
    ...
    def process_section(self, section_name, content, sql, substitutions, image_details=None,
        ...
        for row in cur.fetchall():
            ...
            #image replacement
            if image_details is not None and type(image_details) == tuple and len(image_details) == 2:
                image_name, image_column_name = image_details
                if row[image_column_name] is not None:
                ...
                try:
                    ...
                    if data['deleted']:
                        try:
                            ...
                            if self.soffice_proc is not None:
